...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    projectsDspp = document.getElementById('projects_dspp'),
...
const getUserInputs = () => {
    ...
    projLinkElemm = document.querySelectorAll('.proj_linkk'),
    ...
    designationElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Designation'));
    ...
    return {
        ...
        projectss: fetchValues(['proj_linkk'], projLinkElemm),
...
const displayCV = (userData) => {
    ...
    showListData(userData.projectss, projectsDspp);
